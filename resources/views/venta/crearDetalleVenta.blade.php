...
<div class="card-header py-3">
  ...
  <form action="{{route("admin.agregarProductoVenta",$user->id)}}" method="post" class="row">
    @csrf
...
<!-- #############################################################3######--> 
 ...
 @if(session("productos") !== null)
                    ...
                    <body>
                        @foreach(session("productos") as $producto)
                            <tr>
                                ...
                                <td>
                                    <form action="{{route("admin.quitarProductoDeVenta",$user->id)}}" method="post">
                                        @method("delete")
                                        @csrf
           ...
           <form action="{{route("admin.terminarOCancelarVenta",$user->id)}}" method="post">
                        @csrf
                        @if(session("productos") !== null)
                            <div class="form-group">
