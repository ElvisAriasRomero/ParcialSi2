...
<div class="container-fluid">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <a href="{{route('admin.carrito')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
              class="fas fa-download fa-sm text-white-50"></i> VER CARRITO </a>
  </div>
...
<!--  AQUI INICIA LAS OPCIONES ANTERIORESSS        ######################################################################################### -->
  ...
  <h1 class="text-3xl text-center font-bold">Lista del Carrito</h1>
  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form action="{{route("admin.terminarOCancelarVenta")}}" method="post" enctype="multipart/form-data" >
            @csrf
