...
<form class="mt-4" method="POST" enctype="multipart/form-data" action="{{route('admin.storedProducto')}}">
    ...
    <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="marca" id="marca" name="marca">
    ...
    <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="stock" id="stock" name="stock">
    ...
    <input type="text" class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="precio_compra" id="precio_compra" name="precio_compra">
