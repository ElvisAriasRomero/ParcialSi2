...
<h1 class="text-3xl text-center font-bold">Crear Clientes Personalmente mas usuario</h1>

<form class="mt-4" method="POST" action="{{route('admin.storedClientesPropio')}}">
    @csrf
